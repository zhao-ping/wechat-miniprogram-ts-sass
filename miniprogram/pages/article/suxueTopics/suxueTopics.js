...
var _suxueTopics = (function (_super) {
    __extends(_suxueTopics, _super);
    function _suxueTopics() {
    ...
    _suxueTopics.prototype.onInit = function (e) {
        this.set({ topic_id: e.topic_id });
        this.getList();
    };
    return _suxueTopics;
}(util_1.BasePage));
Page(new _suxueTopics());
